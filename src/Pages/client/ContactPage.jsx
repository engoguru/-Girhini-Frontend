...
import { createContactThunk ,getContactsThunk} from "../../store/slice/contactSlice";
...
const {contactAll}=useSelector((state)=>state?.contact)
...
// console.log(contactAll,"contactAll")
  return (
    <>
      {/* ===== HERO SECTION ===== */}
      <section
      ...
      <section className="direct-contact-section text-center my-5">
        <div className="container">
          ...
          <div className="card border-0 shadow-sm rounded-4 overflow-hidden p-3" style={{ height: "500px" }}>
            <img
              src="https://cdn.pixabay.com/photo/2021/08/18/09/02/women-6555065_640.jpg"
              alt="Contact Team"
              className="img-fluid rounded-4 h-70 "
            />
           ...
           <div className="d-flex flex-wrap justify-content-center gap-4 mt-4">
              ...
              <div className="contact-info-item d-flex align-items-center gap-2">
                ...
                <span className="fw-semibold">V.P.O Malahri, Teh. Indora, Dist. Kangra, H.P 176401</span>
              </div>
              <div className="contact-info-item d-flex align-items-center gap-2">
                <i className="bi bi-envelope-fill text-success fs-5"></i>
                <span className="fw-semibold">iacashokpathania.hp@gmail.com</span>
              </div>
            </div>
        </div>
      </section>
